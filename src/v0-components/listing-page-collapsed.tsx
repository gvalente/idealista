...
import TrustShieldCollapsed from "./trust-shield-collapsed"
...
export default function ListingPageCollapsed() {
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Primary Trust Shield Placement - Collapsed */}
            <div className="w-full">
              <TrustShieldCollapsed score={85} riskLevel="high" onClick={() => openModal(85, "high")} />
            </div>
