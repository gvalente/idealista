...
import TrustBadgeLoading from "./trust-badge-loading"
import TrustShieldModalEnhanced from "./trust-shield-modal-enhanced"
...
const mockListings = [
  {
    ...
    loadingDelay: Math.random() * 150 + 100, // 100-250ms
  },
  {
    id: 2,
    image: "/placeholder.svg?height=200&width=300",
...
export default function SearchResultsWithLoading() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex gap-6">
          ...
          <div className="w-64 space-y-4">
            ...
            {/* Trust Shield Filter */}
            <div className="bg-cream rounded-lg p-4 shadow-sm border border-charcoal/10 textured-background">
      ...
      {/* Enhanced Trust Shield Modal */}
      <TrustShieldModalEnhanced
