...
interface TrustBadgeLoadingPolishedProps {
  finalScore: number
...
export default function TrustBadgeLoadingPolished({
  finalScore,
  finalRiskLevel,
  onClick,
  delay = 0,
}: TrustBadgeLoadingPolishedProps) {
  ...
  return (
    ...
    >
      <HandDrawnShield className={`${styles.shieldClass} transition-all duration-500`} />
