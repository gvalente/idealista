...
const mockListings = [
  {
    ...
    description:
      "Completely renovated apartment on Camèlies Street. The property has 3 rooms, 12 of them doubles, a spacious living...",
    trustScore: 87,
  ...
  },
  {
    ...
    description:
      "AVAILABILITY AND VISITS: Available from 13/08/2025. Check-in must take place within 4 days from this date. Visits can be...",
    trustScore: 64,
  ...
  },
  {
    ...
    description:
      "Temporary rental in Vila de Gràcia TEMPORARY RENTAL - FURNISHED APARTMENT IN VILA DE GRÀCIA (11 MONTHS) Cozy...",
    trustScore: 31,
  ...
  },
  {
    ...
    description:
      "Exclusive temporary penthouse just steps from Paseo de Gràcia. We present this charmingly decorated penthouse, located just a...",
    trustScore: 92,
    riskLevel: "high" as const,
  },
]
          ...
          <div className="flex-1">
            <div className="mb-6">
              <h1 className="text-2xl font-bold text-gray-900 mb-2">
                491 houses and flats for rent in your drawn search area
              </h1>
                ...
                <div key={listing.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex gap-4 p-4">
                    <div className="relative flex-shrink-0">
                      ...
                      />
                      <TrustBadgeSmall score={listing.trustScore} riskLevel={listing.riskLevel} />
