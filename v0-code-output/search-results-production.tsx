...
import TrustBadgeProduction from "./trust-badge-production"
...
export default function SearchResultsProduction() {
                ...
                <div key={listing.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex flex-col sm:flex-row gap-4 p-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-blue-600 hover:text-blue-800 cursor-pointer mb-1 line-clamp-2 sm:truncate">
                        {listing.title}
                      </h3>
                      <div className="text-lg md:text-xl font-bold text-gray-900 mb-1">{listing.price} €/month</div>
