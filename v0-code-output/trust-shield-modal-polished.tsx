...
interface TrustShieldModalPolishedProps {
  isOpen: boolean
  onClose: () => void
  score: number
...
export default function TrustShieldModalPolished({ isOpen, onClose, score, riskLevel }: TrustShieldModalPolishedProps) {
  ...
  const getScoreData = (level: "high" | "medium" | "low") => {
    const data = {
      high: {
        ...
        summary:
          "This listing looks very promising and appears to be from a serious seller. It includes a floor plan and plenty of high-quality photos, and we haven't detected any of the usual red flags. It seems like a strong candidate for your search.",
        analysis: [
          {
            key: "scam",
            label: "Scam Keywords",
      ...
      medium: {
        ...
        summary:
          "This listing has some concerns but may still be legitimate. The price is a bit elevated and the photos are limited, but there aren't any major red flags that would suggest fraud. Exercise normal caution when proceeding.",
        analysis: [
          {
            key: "scam",
            label: "Scam Keywords",
      ...
      low: {
        ...
        summary:
          "Please proceed with caution on this one. This listing contains several characteristics, like unusually low pricing and high-pressure language, that are commonly associated with fraudulent posts. We recommend performing extra due diligence before proceeding.",
        analysis: [
          {
            key: "scam",
            label: "Scam Keywords",
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-lg w-full mx-4 max-h-[90vh] overflow-y-auto">
        <Card className="bg-cream border-0 shadow-2xl paper-texture">
          <CardHeader className="pb-4 relative">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <HandDrawnShield className={`${currentData.titleColor} hand-drawn-shield`} />
                </div>
                <div>
                  <h3 className={`font-medium text-lg font-serif ${currentData.titleColor}`}>Idealista Trust Shield</h3>
          ...
          <CardContent className="pt-0 pb-8">
            {/* AI-Generated Summary - No inset card, stylized font */}
            <div className="mb-6">
              <p className="text-sm text-charcoal font-serif leading-relaxed italic">{currentData.summary}</p>
            </div>
              ...
              <div className="space-y-0">
                {currentData.analysis.map((item, index) => (
                  <div key={item.key}>
                    ...
                    <div
                      className="flex items-center gap-3 py-3 cursor-pointer hover:bg-white/30 rounded transition-colors"
                    ...
                    >
                      ...
                      <div className="flex-shrink-0 p-1 transition-transform duration-200">
      ...
      <style jsx>{`
        ...
        .paper-texture {
          background-image: 
            radial-gradient(circle at 20% 50%, rgba(120, 152, 133, 0.03) 0%, transparent 50%),
            radial-gradient(circle at 80% 20%, rgba(212, 165, 116, 0.02) 0%, transparent 50%),
            radial-gradient(circle at 40% 80%, rgba(193, 123, 107, 0.02) 0%, transparent 50%),
            linear-gradient(135deg, rgba(74,74,74,0.01) 0%, rgba(74,74,74,0.03) 50%, rgba(74,74,74,0.01) 100%),
            url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fillRule='evenodd'%3E%3Cg fill='%234a4a4a' fillOpacity='0.02'%3E%3Ccircle cx='30' cy='30' r='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E");
